...
namespace TheDigitalMedium\ApiHelperCommand\Commands;
...
use TheDigitalMedium\ApiHelperCommand\Generator\Configs\CommandConfigHandler;
use TheDigitalMedium\ApiHelperCommand\Generator\Configs\PathConfigHandler;
use TheDigitalMedium\ApiHelperCommand\Generator\ConsoleTable\GeneratedFilesConsoleTable;
use TheDigitalMedium\ApiHelperCommand\Generator\ConsoleTable\SchemaConsoleTable;
...
class ApiGenerateCommand extends Command
{
    ...
    {
        $defaultOptions = config('api-helper-command.default_generates');
