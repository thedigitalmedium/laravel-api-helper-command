...
namespace TheDigitalMedium\ApiHelperCommand\Generator\Configs;

use TheDigitalMedium\ApiHelperCommand\Generator\Exception\ConfigNotFoundException;
...
class PathConfigHandler
{
    ...
    {
        return Config::get("api-helper-command.groups_files_paths.{$pathGroup}", []);
    }
    ...
    {
        $routeGroupBaseURLs = Config::get('api-helper-command.groups_url_prefixes', []);
    ...
    {
        return Config::get('api-helper-command.default_group', 'default');
    }
    ...
    {
        return array_keys(Config::get('api-helper-command.groups_files_paths'));
    }
    ...
    {
        return (bool) Config::get("api-helper-command.groups_files_paths.{$groupName}");
    }
