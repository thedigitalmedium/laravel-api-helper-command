...
class CommandConfigHandler
{
    ...
    {
        return Config::get('api-helper-command-internal.api_generator_commands', []);
    }
    ...
    {
        $commandClass = Config::get("api-helper-command.api_generator_commands.{$commandName}");
    ...
    {
        $apiGeneratorCommands = Config::get('api-helper-command.api_generator_commands', []);
